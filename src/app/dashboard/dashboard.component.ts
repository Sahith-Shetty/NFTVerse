...
export class DashboardComponent implements OnInit {
    ...
    async ngOnInit(): Promise<void> {
        this.rpcURL = new Web3.providers.HttpProvider(`https://rinkeby.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161`)
    ...
    async getCurrentUserNFTs() {
        ...
        console.log("balanceof: ",await nftContract.methods.balanceOf(this.userAddress))
    }
    ...
    listAllNFTs = async () => {
        ...
        let getTokenIds: any;
        this.loading = true;
        const rpcURL = new Web3.providers.HttpProvider(`https://rinkeby.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161`)
    ...
    listOnOpenSea(token: any){
        window.open(`${environment.OpenSeaUrl}/${environment.Contract_Address}/${token.tokenId}`, '_blank');
    }
